var part_buying = function(message_account, message_password){
    $('#J-add-buy-part-save').click(function(){
        ...
        var content = "客户姓名:" + customer_name +
                      "客户电话:" + customer_phone +
                      "购件意向:" + buy_part_desc
            content = ec_GBK(content);
...
var addSalesman = function (message_account, message_password){
    $("#J-add_salesman").click(function(){
        ...
        var part_buying_id = $("#J-part_buying_id").val();
        ...
        if ( salesman.length === 0 ) {
            ...
            $.ajax({
                ...
                url:  "/questions/" + question_id +"/part_buyings/" + part_buying_id + "/add_salesman",
                dateType: "json",
                cache: false,
                data: {
                        'salesman': salesman,
                ...
                statusCode: {
                    0: function() {
                        ...
                        .complete(function(){window.location.href = "/questions/" + question_id +"/part_buyings";});
                    },
                    200: function() {
                        $.get(href, function () {
                            $('#J-receive_content').append(data);
...
//      var referral = $("#J-referral").val();
      ...
      if( descrition.length === 0 ) {
          ...
          $.ajax({
              ...
              url:  "/questions/" + question_id +"/part_buyings/",
              dateType: "json",
              cache: false,
              data: {
                  'part_buying': {
...
//                      'referral': referral,
              ...
              statusCode: {
                  201: function() {
                      window.location.href = "/questions/" + question_id +"/part_buyings/";
                  },
                  403: function() {
                      window.location.href = "/home/forbidden";
                  },
